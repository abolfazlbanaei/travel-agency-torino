...
function Footer() {
  const linkClass =
    "inline-flex items-center gap-2 rounded-lg text-[18px] text-text-color font-yekan font-normal transition-all duration-300 hover:-translate-y-0.5 hover:text-primary-color hover:font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-color/40 px-1";
